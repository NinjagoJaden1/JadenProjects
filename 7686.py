inFile = open('wordlist.txt', 'r')         # open africa.txt for reading in
...
outFile = open('wordlistasorted.txt', 'w')  # open the output file
for country in countries:
    country = country.strip('\n')
    outputLine = country
    outputLine += ' '*(longestLength-(len(country)-1))  # padding
